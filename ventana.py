...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.gridLayout_7.addWidget(self.label_2, 0, 3, 1, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        spacerItem6 = QtWidgets.QSpacerItem(310, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.tableCli.verticalHeader().setStretchLastSection(True)
